...
class Bilibili():
    def __init__(self):
        ...
        self.baseUrl = 'http://api.bilibili.com/archive_rank/getarchiverankbypartion?callback=jQuery172042490286005350586_timestamp&type=jsonp&tid=tid_number&pn=page_number' # timestamp:时间戳，tid:tid，pn:页数
        self.videoTid = '25'
        self.start_page, self.end_page = 2001, 2500
